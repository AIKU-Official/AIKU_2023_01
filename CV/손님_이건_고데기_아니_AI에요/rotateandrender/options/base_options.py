...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='rs_model', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--no_gaussian_landmark', action='store_true', default='True', help='whether to use no_gaussian_landmark (1.0 landmark) for rotatespade model')
        parser.add_argument('--label_mask', action='store_true', default = 'True', help='whether to use face mask')
