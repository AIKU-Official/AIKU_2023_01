...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--align', action='store_true', default='True', help='whether to save align')
        parser.add_argument('--yaw_poses', type=float, default=0, nargs='+', help='yaw poses list during testing')
