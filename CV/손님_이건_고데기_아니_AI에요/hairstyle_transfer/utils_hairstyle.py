...
import dlib
# predictor = dlib.shape_predictor('./hairstyle_transfer/shape_predictor_68_face_landmarks.dat')
# predictor = dlib.shape_predictor('./shape_predictor_68_face_landmarks.dat') 
predictor = dlib.shape_predictor('/home/aiku/AIKU/hair/hairstyle_transfer/shape_predictor_68_face_landmarks.dat')
# 수정 전. ./~/hair 에서 merge.py돌리면 위 코드의 경로로 해야됨.
